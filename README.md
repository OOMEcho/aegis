...
本仓库为 **JDK 21 + Spring Boot 3.5.6 + Spring Security 6.5.5** 版本，与 JDK 1.8 版本（[aegis (master 分支)](https://github.com/OOMEcho/aegis)）功能保持一致。
...
- 点击跳转[JDK 1.8 版本后端仓库](https://github.com/OOMEcho/aegis)
