...
INSERT INTO `t_whitelist` (`id`, `create_by`, `update_by`, `create_time`, `update_time`, `deleted`, `version`, `remark`, `request_method`, `request_uri`, `description`, `status`) VALUES (1975094173811982339, NULL, NULL, now(), now(), 0, 1, NULL, 'GET', '/file/preview/**', '文件预览公开接口', '0');
...
('PUT', '/notice/publish/*', 'system:notice:publish', '0', '通知管理-发布', 1),
('PUT', '/notice/revoke/*', 'system:notice:revoke', '0', '通知管理-撤销', 1),
