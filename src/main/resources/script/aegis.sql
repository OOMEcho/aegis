...
(
    ...
    `order_num`      INT             NOT NULL DEFAULT 0 COMMENT '显示顺序',
    `request_method` VARCHAR(10)              DEFAULT NULL COMMENT '请求方法,GET,POST,PUT,DELETE,ALL=不限制',
    `request_uri`    VARCHAR(255)             DEFAULT NULL COMMENT 'URI匹配模式,支持Ant风格,比如/api/user/**',
